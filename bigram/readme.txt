...
To run using maven (only for standalone):
	...
	$ mvn exec:java -Dexec.mainClass="heigvd.bda.labs.bigram.Pairs" -Dexec.args="NUM_REDUCERS INPUT_PATH OUTPUT_PATH"
...
To run using Hadoop (for both standalone and pseudo-distributed):
	...
	$ ${HAOOP_HOME}/bin/hadoop jar JAR_FILE_PATH heigvd.bda.labs.bigram.Pairs NUM_REDUCERS INPUT_PATH OUTPUT_PATH
