...
To run using maven (only for standalone):
	...
	$ mvn exec:java -Dexec.mainClass="heigvd.bda.labs.relfreq.OrderInversion" -Dexec.args="NUM_REDUCERS INPUT_PATH OUTPUT_PATH"
...
To run using Hadoop (for both standalone and pseudo-distributed):
	...
	$ ${HAOOP_HOME}/bin/hadoop jar JAR_FILE_PATH heigvd.bda.labs.relfreq.OrderInversion NUM_REDUCERS NPUT_PATH OUTPUT_PATH
